...
#include <type_traits> // for enable_if_t, declval, is_convertible, ...
#include <algorithm>
...
// compile time, so the compiler wouldn't have to warn indiscriminately, but
...
namespace gsl
{
	...
	private:
		...
		// in sub spans and constructors from arrays
